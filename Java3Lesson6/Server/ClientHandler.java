...
public class ClientHandler {
    ...
    public ClientHandler(ExecutorService service, Server server, Socket socket) {
        ...
        try {
            ...
            LOGGER.debug("Проблемы при создании обработчика");
            ...
            if (message.startsWith(ServerCommandConstants.AUTHENTICATION)) {
                ...
                if (nickName != null) {
                    if (!server.isNickNameBusy(nickName)) {
                        ...
                        this.nickName = nickName;
                        LOGGER.info(nickName + "\t подключается.................");
    ...
    private void readMessages() throws IOException {
        while (true) {
            ...
            LOGGER.info("Пользователь " + nickName + " написал: " + messageInChat);
    ...
    private void closeConnection() throws IOException {
        ...
        try {
            LOGGER.info("Пользователь " + nickName + "покинул чат");
            outputStream.close();
            inputStream.close();
            socket.close();
        } catch (IOException exception) {
